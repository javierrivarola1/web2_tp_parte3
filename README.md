...
<ul>
  <li>La API ofrece servicios para listar, agregar y modificar datos de una base de datos.
   ...
   <li>Los servicios permiten ordenar, filtrar y paginar los resultados.
</li>
   <li>Se asegura que se manejen los códigos de estado HTTP adecuados (200, 201, 400, 404, 500).
</li>
